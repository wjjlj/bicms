    ...
    var api = {
        ...
        bellDraw: function () {
            var bellHtml = "<span data-type='1' class='message-bell-btn' "+ (option.msgUnReadData > 0?("title='"+ option.msgUnReadData + "条新消息'"):"") +">" +
                "<i class='fa fa-bell-o fa-lg'></i>"+ (option.msgUnReadData > 0?"<span class='badge-dot'></span>":"") +"</span>" +
                "<span data-type='2' class='message-bell-btn' "+ (option.noticeUnReadData > 0?("title='"+ option.noticeUnReadData +"条新提醒'"):"") +">" +
                "<i class='fa fa-at fa-lg'></i>" + (option.noticeUnReadData > 0?("<span class='badge'>"+ option.noticeUnReadData +"</span>"):"") +
                "</span>";
        ...
        caculatePosition: function(elemt) {
            ...
            $(".message-frame").css('position', "fixed").css('left', divX).css('top', 60);
            //-------
        },
        /**
         * 每条消息组装
